//! Renderers for agentlock-cli reports.
//!
//! Implements [`Renderable`] for the major report types.

use std::io::Write;

use agentlock_attestation::{ReleaseAttestation, VerificationResult};
use agentlock_bundle::BundleSummary;
use agentlock_core::{CliError, CliResult, Severity, ValidationReport};
use agentlock_diff::DiffReport;
use agentlock_replay_local::ReplayReport;
...
mod tests {
    use super::*;
    use agentlock_core::ValidationIssue;
