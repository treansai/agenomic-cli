...
pub struct ValidationIssue {
    /// Stable diagnostic code (e.g. `agenomic::bundle::missing_required_file`).
    pub code: String,
...
impl ValidationReport {
    ...
    ///
    /// ```
    /// # use agenomic_core::report::{ValidationReport, ValidationIssue};
    /// # use agenomic_core::severity::Severity;
    ...
    ///
    /// ```
    /// # use agenomic_core::report::ValidationReport;
    /// # use agenomic_core::severity::Severity;
